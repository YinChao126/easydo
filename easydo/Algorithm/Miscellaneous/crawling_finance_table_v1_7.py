...
#        print(zichanfuzhai)
        zichanfuzhai.to_csv(
            self.work_path + '/' + self.stock_code + '_' + 'balance_sheet.csv',
            encoding='gbk')
...
#        print(xianjinliuliang)
        xianjinliuliang.to_csv(
            self.work_path + '/' + self.stock_code + '_' + 'cash_flow.csv',
            encoding='gbk')
...
#        print(lirunbiao)
        lirunbiao.to_csv(
            self.work_path + '/' + self.stock_code + '_' + 'profit.csv',
            encoding='gbk')
