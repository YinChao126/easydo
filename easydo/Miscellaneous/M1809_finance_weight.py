...
result_chengzhang = pd.read_csv(
    'D:/999github/anack/M1809/xst/result_chengzhang.csv')
result_changzhai = pd.read_csv(
    'D:/999github/anack/M1809/xst/result_changzhai.csv')
...
df_final = df_final[(df_final.firstincrase > 0.1)
                    & (df_final.secondincrase > 0.1)]
...
'''
features = features[[
    'targ20174', 'nav20174', 'gross_profit_rate20174', 'cashflowratio20174',
    'net_profit_ratio20174', 'mbrg20174', 'currentratio20174',
    'currentasset_turnover20174', 'inventory_days20174'
]]
